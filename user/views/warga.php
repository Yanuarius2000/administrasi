<div class="container" style="margin-top: 130px;">
    <div class="container mt-5">
        <h2 class="text-dark">Data Warga RT <?= $namart ?></h2>
        <div class="row">
        ...
        <div class="card-body table-responsive">
            <table id="bootstrap-data-table" class="table table-striped table-sm">
                ...
                <tbody>
                    <?php
                    $sql = mysqli_query($con, "SELECT * FROM user WHERE user_rt_id = '$ketuart' ORDER BY user_id");
                    $no = 1;
...
if (isset($_POST['simpan'])) {
    ...
    if ($user_password != $user_password2) {
        ...
        if ($sql) {
            echo "<script>alert('Pendaftaran Berhasil !');window.location='?page=warga';</script>";
        } else {
            echo "<script>alert('Pendaftaran Gagal !');window.location='?page=warga';</script>";
        }
    }
}
?>