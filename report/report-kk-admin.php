...
// $sql = mysqli_query($con, "SELECT * FROM kk, user, rt WHERE kk.kk_user=user.user_id AND kk.kk_rt=rt.rt_id AND kk.kk_tanggal_verifikasi BETWEEN '$dari' AND '$hingga'");
...
$pdf->Cell(25, 0);
$pdf->Cell(25, 10, 'LAPORAN ADMINISTRASI KARTU KELUARGA', 0, 1);
...
while ($data = mysqli_fetch_assoc($sql)) {
    ...
    $pdf->Cell(30, 5, $data['kk_tanggal_verifikasi'], 1, 1);
}
