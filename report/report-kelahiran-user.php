...
$sql = mysqli_query($con, "SELECT * FROM kelahiran WHERE kelahiran_id = '$id'");
...
$pdf->Cell(10, 8, ':', 0, 0);
$pdf->Cell(10, 8, $data['kelahiran_jk'] . ' bernama ' . $data['kelahiran_nama'], 0, 1);
...
$pdf->Cell(115, 0);
$pdf->Cell(115, 5, 'Desa, ' . $data['kelahiran_tanggal_verifikasi'], 0, 1);
...
$pdf->Cell(189, 20, '', 0, 1);
//$pdf->Image('../assets/img/Mafer-Leitex1666673690.jpeg', 125, 232, 40, 20);
