...
$sql = mysqli_query($con, "SELECT * FROM domisili WHERE domisili_id = '$id'");
...
$pdf->Cell(10, 8, '', 0, 0);
$pdf->Cell(40, 8, 'Bahwa orang tersebut berdomisili di RT : ' . $datauser['rt_nama'] . ' / RW : ' . $datauser['rw_nama'] . 'Desa Dualasi, Kabupaten Belu, Provinsi Nusa ', 0, 1);
$pdf->Cell(10, 8, '', 0, 0);
...
$pdf->Cell(115, 0);
$pdf->Cell(115, 5, 'Desa, ' . $data['domisili_tanggal_verifikasi'], 0, 1);
