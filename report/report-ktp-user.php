...
$sql = mysqli_query($con, "SELECT * FROM ktp WHERE ktp_id = '$id'");
...
$pdf->Cell(40, 0);
$pdf->Cell(45, 10, 'SURAT KETERANGAN KTP', 0, 1);
...
$pdf->Cell(10, 8, '', 0, 0);
$pdf->Cell(40, 8, 'Tenggara Timur. Surat pengantar ini dibuat sebagai kelengkapan pengurusan KTP.', 0, 1);
...
$pdf->Cell(115, 0);
$pdf->Cell(115, 5, 'Dualasi, ' . $data['ktp_tanggal_verifikasi'], 0, 1);
