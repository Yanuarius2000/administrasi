...
$pdf->Cell(40, 0);
$pdf->Cell(40, 10, 'LAPORAN ADMINISTRASI IZIN USAHA', 0, 1);
...
$pdf->Cell(30, 5, 'Nama Usaha', 1, 0);
$pdf->Cell(30, 5, 'Pemilik', 1, 0);
$pdf->Cell(30, 5, 'Alamat', 1, 0);
$pdf->Cell(25, 5, 'Tanggal Verifikasi', 1, 1);

$pdf->SetFont('Arial', '', 8);
$no = 1;
$sql = mysqli_query($con, "SELECT * FROM izin_usaha, user, rt WHERE izin_usaha.izin_usaha_user=user.user_id AND izin_usaha.izin_usaha_rt=rt.rt_id AND izin_usaha.izin_usaha_tanggal_verifikasi BETWEEN '$dari' AND '$hingga'");
while ($data = mysqli_fetch_assoc($sql)) {
    $pdf->Cell(5, 5, '', 0, 0);
    $pdf->Cell(6, 5, $no++ . '.', 1, 0);
    $pdf->Cell(40, 5, $data['user_nama'], 1, 0);
    $pdf->Cell(15, 5, $data['rt_nama'], 1, 0);
    $pdf->Cell(30, 5, $data['izin_usaha_nama'], 1, 0);
    $pdf->Cell(30, 5, $data['izin_usaha_alamat'], 1, 0);
    $pdf->Cell(30, 5, $data['izin_usaha_nama_pemilik'], 1, 0);
    $pdf->Cell(25, 5, $data['izin_usaha_tanggal_verifikasi'], 1, 1);
}
